...
def max_path_sum(root):
    # RECURSIVE (Iterative method for this problem will get too compilcated, hence for 
    # such problems where there is path finding and path sum maxing, Recursive is the approach to use)
    # TIME : O(n)
    # SPACE : O(n)
    if root is None:
        return float("-inf")
